...
<head>
    ...
    <link href="<c:url value="/plugins/bower_components/datatables/jquery.dataTables.min.css" />" rel="stylesheet" type="text/css" />
...
<body class="fix-header">
    ...
    <script src="<c:url value="/plugins/bower_components/datatables/jquery.dataTables.min.js" />"></script>
