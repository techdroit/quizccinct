...
<!-- Page plugins css -->
<link
	href="<c:url value="/plugins/bower_components/clockpicker/dist/jquery-clockpicker.min.css" />"
	rel="stylesheet">
<!-- Color picker plugins css -->
<link
	href="<c:url value="/plugins/bower_components/jquery-asColorPicker-master/css/asColorPicker.css" />"
	rel="stylesheet">
<!-- Date picker plugins css -->
<link
	href="<c:url value="/plugins/bower_components/bootstrap-datepicker/bootstrap-datepicker.min.css" />"
	rel="stylesheet" type="text/css" />
<!-- Daterange picker plugins css -->
<link
	href="<c:url value="/plugins/bower_components/timepicker/bootstrap-timepicker.min.css" />"
	rel="stylesheet">
<link
	href="<c:url value="/plugins/bower_components/bootstrap-daterangepicker/daterangepicker.css" />"
	rel="stylesheet">
<!-- animation CSS -->
<link href="<c:url value="/css/animate.css" />" rel="stylesheet">
<!-- Custom CSS -->
...
<body class="fix-header">
			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="white-box">
							<c:choose>
								<c:when test="${quizInfo.quizId == 0}">
									<h3 class="box-title m-b-0">Add Quiz</h3>
									<spring:url value="/quizzes/add" var="saveOrUpdateQuiz" />
								</c:when>
								<c:otherwise>
									<h3 class="box-title m-b-0">Update Quiz</h3>
									<spring:url value="/quizzes/update" var="saveOrUpdateQuiz" />
								</c:otherwise>
							</c:choose>
							...
							<div class="row">
								<div class="col-sm-12 col-xs-12">
									...
									<form:form method="post" modelAttribute="quizInfo"
										action="${saveOrUpdateQuiz}">

										<form:hidden path="quizId" />

										<c:if test="${quizInfo.quizId > 0}">
											<c:set var="readonly" value="true" />
										</c:if>

										<div class="form-group">
											<label for="exampleInputEmail1">Name</label>
											<form:input path="quizName" type="text" class="form-control"
												id="" placeholder="Quiz Name" readonly="${readonly}" />
										</div>

										<div class="form-group">
											<label for="exampleInputEmail1">Description</label>
											<form:input path="quizDescription" type="text"
										...
										<div class="form-group">
											...
											<form:select path="visibilityModeId" class="form-control"
												items="${visibility}" />
											<span class="help-block"> Select accessibility level</span>
										</div>

										<div class="form-group">
											<label class="control-label">Display</label>
											<form:select path="displayModeId" class="form-control"
												items="${display}" />
											<span class="help-block"> How the quiz questions are
												displayed </span>
										</div>

										<div class="form-group">
											<label class="control-label">Status</label>
											<form:select path="statusId" class="form-control"
												items="${status}" />
											<span class="help-block"> The status of the quiz </span>
										</div>

										<div class="form-group">
											<label class="control-label">Selection</label>
											<form:select path="selectionModeId" class="form-control"
												items="${selection}" />
											<span class="help-block"> How questions are selected
												from this quiz </span>
										</div>
										...
										<div class="form-group">
											<label class="control-label">Date</label> <input
												...
												name="daterange" value="" placeholder="" /> <span
												class="help-block"> Pick start and end date </span>
										</div>
										 -->
	...
	<!-- Plugin JavaScript -->
	<script
		src="<c:url value="/plugins/bower_components/moment/moment.js" />"></script>
	<!-- Clock Plugin JavaScript -->
	<script
		src="<c:url value="/plugins/bower_components/clockpicker/dist/jquery-clockpicker.min.js" />"></script>
	<!-- Color Picker Plugin JavaScript -->
	<script
		src="<c:url value="/plugins/bower_components/jquery-asColorPicker-master/libs/jquery-asColor.js" />"></script>
	<script
		src="<c:url value="/plugins/bower_components/jquery-asColorPicker-master/libs/jquery-asGradient.js" />"></script>
	<script
		src="<c:url value="/plugins/bower_components/jquery-asColorPicker-master/dist/jquery-asColorPicker.min.js" />"></script>
