		...
		<div class="top-left-part">
			...
			<a class="logo" href="index.html"> <!-- Logo icon image, you can use font-icon also -->
				<b> <!--This is dark logo icon-->
					<img src="<c:url value="/plugins/images/admin-logo.png" />"
					alt="home" class="dark-logo" />
				<!--This is light logo icon-->
					<img src="<c:url value="/plugins/images/admin-logo-dark.png" />" alt="home"
					class="light-logo" />
			</b> <!-- Logo text image you can use text also -->
				<span class="hidden-xs"> <!--This is dark logo text-->
					<img src="<c:url value="/plugins/images/admin-text.png" />"
					alt="home" class="dark-logo" />
				<!--This is light logo text-->
					<img src="<c:url value="/plugins/images/admin-text-dark.png" />"
					...
					<li>
						<div class="message-center">
							<a href="#">
								...
								<div class="user-img">
									<img src="<c:url value="/plugins/images/users/sonu.jpg" />"
										alt="user" class="img-circle"> <span
								...
								<div class="user-img">
									<img src="<c:url value="/plugins/images/users/arijit.jpg" />"
										alt="user" class="img-circle"> <span
